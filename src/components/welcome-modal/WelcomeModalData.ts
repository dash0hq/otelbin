...
export const WelcomeModalData: IWelcomeModal[] = [
    ...
    },
    {
        ...
        description:
            "Craft your configuration seamlessly in the Editor with real-time syntax validation at your side.",
        image: WelcomeModal2,
    },
    {
        title: "Easily find your config errors.",
        description:
            "Effortlessly pinpoint and rectify configuration errors with simplicity.",
        image: WelcomeModal3,
    },
];
