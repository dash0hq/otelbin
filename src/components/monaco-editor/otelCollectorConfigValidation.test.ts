...
import { capitalize, findLineAndColumn, extractMainItemsData, extractServiceItems, findLeafs, IValidateItem, customValidate } from "./otelCollectorConfigValidation";
import { IItem, getParsedValue } from './parseYaml';
