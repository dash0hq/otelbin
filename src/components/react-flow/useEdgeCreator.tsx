...
function useEdgeCreator(
    ...
    useEffect(() => {
        ...
        const calculateProcessorsNode = (
            processorsNodes: Node[],
            index: number
        ) => {
        ...
        const childNodes = (parentNode: string) => {
            const eachParentNode = nodeIdsArray.filter(
